...
internal sealed class RadianceLiteEmissionCustomEffect(IGraphicsDevicesAndContext devices) : D2D1CustomShaderEffectBase(Create<EffectImpl>(devices))
{
    ...
    private sealed class EffectImpl : D2D1CustomShaderEffectImplBase<EffectImpl>
    {
        ...
        public EffectImpl() : base(ShaderResourceUri.Get("RadianceLiteEmission"))
        {
        }
